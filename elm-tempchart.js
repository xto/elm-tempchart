...
Elm.Main.make = function (_elm) {
   ...
   var saveButton = F2(function (address,model) {
      ...
      _U.list([$Html$Attributes.$class("setName"),A2($Html$Events.onClick,address,PostReadings)]),
      _U.list([$Html.text("Save Data")]))]));
   });
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("container")]),
      _U.list([A2(entryForm,address,model),A2(drawChart,extractAllTimes(model),extractAllTemps(model)),A2(saveButton,address,model)]));
   });
   ...
   var postReadings = function (model) {
      var potato = $Http.multipart(_U.list([A2($Http.stringData,"mash_name",model.mashName)
                                           ,A2($Http.stringData,
                                           "temperatures",
   ...
   var update = F2(function (action,model) {
      ...
      {case "RequestReadings": return {ctor: "_Tuple2",_0: model,_1: getTempAction};
         ...
         case "SetMashName": return !_U.eq(model.mashName,"") ? {ctor: "_Tuple2"
                                                                ,_0: A3(Model,model.temperatureReadings,model.mashName,true)
                                                                ,_1: $Effects.none} : {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         case "UpdateMashName": return {ctor: "_Tuple2",_0: A3(Model,model.temperatureReadings,_p0._0,model.mashNamed),_1: $Effects.none};
